...
export const RETAIL_DEMO: IndustryDemoProfile = {
  ...
  transactions: [
    ...
    t('rt-tx-5', '2026-12-10', 'Holiday Season Batch A', 650000, '2026-12-10', 0.95, 'PENDING'),
    t('rt-tx-6', '2026-12-22', 'Store Clearance Settlement', 720000, '2026-12-22', 1.0, 'PENDING'),
  ],
  payables: [
    ...
    p('rt-pay-5', 'UrbanMart Warehouse Rent', 160000, '2026-12-01', 'Facility Rent', 'DUE'),
    p('rt-pay-6', 'Apparel Wholesale Co', 450000, '2026-12-15', 'Merchandise', 'DUE'),
  ],
  expenses: [
    ...
    e('rt-exp-5', '2026-12-05', 'Store Staff Payroll', 180000),
    e('rt-exp-6', '2026-12-25', 'Store Operations', 60000),
  ],
  inventory: [
...
export const SAAS_DEMO: IndustryDemoProfile = {
  ...
  transactions: [
    ...
    t('sa-tx-5', '2026-12-12', 'Annual Plan Renewals (Tier 2)', 580000, '2026-12-12', 0.92, 'PENDING'),
    t('sa-tx-6', '2026-12-26', 'Monthly MRR Collections', 520000, '2026-12-26', 0.95, 'PENDING'),
  ],
  payables: [
    ...
    p('sa-pay-4', 'SaaS Tooling Suite', 95000, '2026-12-01', 'Software Licenses', 'DUE'),
    p('sa-pay-5', 'Cloud Infrastructure AWS', 280000, '2026-12-18', 'Cloud Hosting', 'DUE'),
  ],
  expenses: [
    ...
    e('sa-exp-5', '2026-12-05', 'Engineering Payroll', 380000),
    e('sa-exp-6', '2026-12-25', 'Marketing & Sales', 120000),
  ],
  inventory: [],
  suppliers: [],
  sales: [],
...
export const RESTAURANT_DEMO: IndustryDemoProfile = {
  ...
  transactions: [
    ...
    t('re-tx-5', '2026-12-12', 'Corporate Year-End Banquet', 450000, '2026-12-12', 0.95, 'PENDING'),
    t('re-tx-6', '2026-12-24', 'Festive Holiday Dining', 580000, '2026-12-24', 0.92, 'PENDING'),
  ],
  payables: [
    ...
    p('re-pay-5', 'Kitchen Equipment Lease', 90000, '2026-12-01', 'Equipment', 'DUE'),
    p('re-pay-6', 'Fresh Food Suppliers', 340000, '2026-12-14', 'Food Supply', 'DUE'),
  ],
  expenses: [
    ...
    e('re-exp-5', '2026-12-05', 'Kitchen Staff Payroll', 150000),
    e('re-exp-6', '2026-12-25', 'Restaurant Rent & Utilities', 110000),
  ],
  inventory: [
...
export const CONSTRUCTION_DEMO: IndustryDemoProfile = {
  ...
  transactions: [
    ...
    t('co-tx-5', '2026-12-15', 'Milestone 2 — Phase B Client', 1100000, '2026-12-15', 0.92, 'PENDING'),
  ],
  payables: [
    ...
    p('co-pay-5', 'Equipment Rental Co', 180000, '2026-12-01', 'Equipment', 'DUE'),
    p('co-pay-6', 'Steel & Cement Suppliers', 750000, '2026-12-16', 'Materials', 'DUE'),
  ],
  expenses: [
    ...
    e('co-exp-5', '2026-12-05', 'Site Office & Staff', 130000),
    e('co-exp-6', '2026-12-25', 'Site Operations', 90000),
  ],
  inventory: [
