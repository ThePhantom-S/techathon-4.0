...
export const INDUSTRY_OPTIONS: IndustryOption[] = [
  { id: 'manufacturing', name: 'Manufacturing', icon: '🏭', description: 'Track raw materials, production, inventory and supplier commitments.', category: 'Production' },
  { id: 'wholesale', name: 'Wholesale / Distribution', icon: '📦', description: 'Track supplier purchases, inventory, customer orders and collections.', category: 'Distribution' },
  { id: 'retail', name: 'Retail / E-commerce', icon: '🛍️', description: 'Track inventory, sales, suppliers, customer demand and cash.', category: 'Commerce' },
  { id: 'saas', name: 'SaaS / Software', icon: '💻', description: 'Track recurring revenue, customer collections, payroll and operating costs.', category: 'Technology' },
  { id: 'consulting', name: 'Consulting / Professional Services', icon: '🧑‍💼', description: 'Track project billing, receivables, payroll and operating expenses.', category: 'Services' },
  { id: 'restaurant', name: 'Restaurant / Food', icon: '🍽️', description: 'Track food inventory, suppliers, daily sales and payroll.', category: 'Food Service' },
  { id: 'logistics', name: 'Logistics / Transportation', icon: '🚚', description: 'Track fleet costs, customer invoices, fuel and operating expenses.', category: 'Transport' },
  { id: 'healthcare', name: 'Healthcare', icon: '🏥', description: 'Track supplies, patient/customer receivables, payroll and operating costs.', category: 'Healthcare' },
  { id: 'construction', name: 'Construction', icon: '🏗️', description: 'Track project costs, supplier payments, billing milestones and receivables.', category: 'Construction' },
  { id: 'other', name: 'Other', icon: '🔧', description: 'Use a general-purpose FlowShield financial model.', category: 'General' },
];
